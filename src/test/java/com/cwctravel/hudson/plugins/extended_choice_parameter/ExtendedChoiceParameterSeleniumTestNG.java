...
public class ExtendedChoiceParameterSeleniumTestNG {
	...
	public void init() {
		...
		System.setProperty("webdriver.chrome.driver", file.getAbsolutePath()); // Sets the system property indicated by the specified key.		
...
//		element.click();
//		Thread.sleep(2000);
//		driver.findElement(By.linkText("Execute Windows batch command")).click(); // Shell
//																					// script
//																					// to
//																					// create
//																					// multi-level
